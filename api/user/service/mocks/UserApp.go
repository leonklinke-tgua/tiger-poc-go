...
func (_m *UserApp) CreateUser(ctx context.Context, user *structs.User) (*structs.User, error) {
	...
	var r0 *structs.User
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *structs.User) (*structs.User, error)); ok {
		return rf(ctx, user)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *structs.User) *structs.User); ok {
		r0 = rf(ctx, user)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, *structs.User) error); ok {
		r1 = rf(ctx, user)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *UserApp_CreateUser_Call) Run(run func(ctx context.Context, user *structs.User)) *UserApp_CreateUser_Call {
...
func (_c *UserApp_CreateUser_Call) Return(_a0 *structs.User, _a1 error) *UserApp_CreateUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserApp_CreateUser_Call) RunAndReturn(run func(context.Context, *structs.User) (*structs.User, error)) *UserApp_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *UserApp) GetUser(ctx context.Context, id string) (*structs.User, error) {
	ret := _m.Called(ctx, id)
...
func (_c *UserApp_GetUser_Call) Return(_a0 *structs.User, _a1 error) *UserApp_GetUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserApp_GetUser_Call) RunAndReturn(run func(context.Context, string) (*structs.User, error)) *UserApp_GetUser_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateUser provides a mock function with given fields: ctx, user
func (_m *UserApp) UpdateUser(ctx context.Context, user *structs.User) error {
	ret := _m.Called(ctx, user)
...
func (_c *UserApp_UpdateUser_Call) Run(run func(ctx context.Context, user *structs.User)) *UserApp_UpdateUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*structs.User))
	})
	return _c
...
func (_c *UserApp_UpdateUser_Call) RunAndReturn(run func(context.Context, *structs.User) error) *UserApp_UpdateUser_Call {
	_c.Call.Return(run)
	return _c
}
