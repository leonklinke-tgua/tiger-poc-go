...
//go:generate mockery --name PolicyRepository --with-expecter --srcpkg github.com/theguarantors/tiger/api/policy/app
type PolicyRepository interface {
	Get(ctx context.Context, id string) (*structs.Policy, error)
}

//go:generate mockery --name UserService --with-expecter --srcpkg github.com/theguarantors/tiger/api/policy/app
...
func (u *PolicyApp) GetPolicy(ctx context.Context, id string) (*structs.Policy, error) {
...
func (u *PolicyApp) fetchUser(ctx context.Context, id string) (*structs.User, error) {
