...
func (_m *UserRepository) Get(ctx context.Context, id string) (*entities.User, error) {
	ret := _m.Called(ctx, id)
...
func (_c *UserRepository_Get_Call) Return(_a0 *entities.User, _a1 error) *UserRepository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepository_Get_Call) RunAndReturn(run func(context.Context, string) (*entities.User, error)) *UserRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
